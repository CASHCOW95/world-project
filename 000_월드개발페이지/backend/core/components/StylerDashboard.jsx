...
import { PenTool, Copy, Check, ExternalLink, LayoutGrid, Search, Flame, TrendingUp, Cpu, Award, FileText, BadgeHelp, DollarSign, Users, MousePointer, ShieldAlert, RefreshCw, Layers, Sparkles, Clock, Compass, Settings, Link2, StopCircle, CalendarClock } from 'lucide-react';
...
function OriginalStylerDashboard() {
  ...
  const [, setProfileForm] = useState(null);
  ...
  }, [platform, publisherConfig.profiles, selectedProfileId]);
    ...
    try {
      const res = await fetch('/api/generate-titles', {
        ...
        body: JSON.stringify({
          ...
          category: catName || kwObj.category || ''
        })
      });
      const data = await res.json();
