...
def main():
    sample_file = os.path.join('sung', '레거시', '자막', '(260602)Negative Premium -4%, Bitcoin Breaks 120-Day Line! Strategy\'s First Bitcoin Sell.srt')
    ...
    # Save test outputs
    with open('refined_test.srt', 'w', encoding='utf-8') as f:
        f.write(refined_srt)
    with open('refined_test.txt', 'w', encoding='utf-8') as f:
        f.write(plain_text)
        
    print("Saved refined_test.srt and refined_test.txt.")
