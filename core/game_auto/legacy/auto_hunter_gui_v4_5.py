...
# 설정 파일 경로
CONFIG_FILE = "hunter_premium_v4_5_config.json"
...
class AutoHunterV4_5:
    def __init__(self, root):
        self.root = root
        self.root.title("오토헌터 프리미엄 v4.5 (클래식 엔진 + DEL)")
        ...
        self.KEY_DASH = "space"
        self.KEY_JUMP = "alt"
        self.KEY_PERIODIC = "del" # 5분마다 누를 키
    ...
    def setup_ui(self):
        ...
        # 1. 프리뷰 (대형)
        group1 = ttk.LabelFrame(container, text=" [ 1. 실시간 미니맵 상황 (클래식 엔진) ] ", padding="10")
        ...
        ttk.Label(group3, text="※ 5분마다 DEL 키 2회 자동 연타 기능 포함", foreground="#00adb5", font=("Malgun Gothic", 8)).pack(anchor=tk.W, pady=(5,0))

        # 4. 범위 및 정보
        group4 = ttk.LabelFrame(container, text=" [ 4. 활동 범위 및 정보 ] ", padding="10")
