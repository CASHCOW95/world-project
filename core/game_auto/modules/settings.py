...
class SettingsManager:
    ...
    def save_settings_silently(self):
        ...
        self.main_win.profiles_data[n] = {
            ...
            "pingpong_recovery": {
                ...
                "return_delay": float(self.main_win.txt_pingpong_return_delay.text().strip() or "1.0"),
                "recovery_delay": float(self.main_win.txt_pingpong_recovery_delay.text().strip() or "1.0"),
    ...
    def apply_profile_data(self, n):
        ...
        self.main_win.txt_pingpong_return_delay.setText(str(pr.get("return_delay", 1.0)))
        self.main_win.txt_pingpong_recovery_delay.setText(str(pr.get("recovery_delay", 1.0)))
